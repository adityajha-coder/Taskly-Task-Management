(function () {
    ...
    function renderStats(total, todo, inProgress, overdue) {
        document.getElementById('stats-grid').innerHTML = `
            <div class="stat-tile card blue">
                <div class="stat-value">${total}</div>
                <div class="stat-label">Total</div>
            </div>
            <div class="stat-tile card amber">
                <div class="stat-value">${todo}</div>
                <div class="stat-label">To Do</div>
            </div>
            <div class="stat-tile card violet">
                <div class="stat-value">${inProgress}</div>
                <div class="stat-label">Active</div>
            </div>
            <div class="stat-tile card red ${overdue > 0 ? 'has-overdue' : ''}">
    ...
    function renderProgress(total, done, user) {
        ...
        else if (pct === 100) motivationMsg = 'All tasks completed!';
        ...
        else if (done > 0) motivationMsg = 'Keep the momentum going';
